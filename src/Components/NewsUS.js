    ...
    let apiKey = "9a5b88e493d44e5db9b6889d860b3043"
      ...
      useEffect( () => {
        const fetchData = async () => {
          let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=9a5b88e493d44e5db9b6889d860b3043"
      ...
      return(
        <div className="container my-3">
          <h1 className="text-center"><b><u>News US</u></b></h1>
          <div className="row">
